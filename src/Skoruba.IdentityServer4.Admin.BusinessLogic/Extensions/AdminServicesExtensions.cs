...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class AdminServicesExtensions
    {
            ...
            where TLogDbContext : DbContext, IAdminLogDbContext
        {
            ...
            services.AddTransient<IEncryptionKeyRepository, EncryptionKeyRepository<TConfigurationDbContext>>();
            ...
            services.AddTransient<IEncryptionKeyService, EncryptionKeyService>();
